        ...
        <div class="row">
            <div class="col-sm-12 main-contentarea">
                ...
                <div class="grap-outer">
                    ...
                    <img class="img-responsive" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/graph1.png" alt="Steel Price Graphs" title="Steel Price Graphs" >
                </div> 
                <div class="grap-outer">
                    <h3>Pakistan Price Graph</h3>
                    <img class="img-responsive" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/graph2.png" alt="Pakistan Price Graph" title="Pakistan Price Graph" >
                </div>
