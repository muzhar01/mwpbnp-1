        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <a href="<?php echo Yii::app()->createUrl('category/create'); ?>" class="btn btn-success">Create New</a>
                    </div>
                    <?php
                        ...
                        <table id="example1" class="table table-bordered table-striped table-userbox">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $cat->parent->name==''?'-':$cat->parent->name; ?></td>
                                    <td><?php echo $cat->name; ?></td>
                                    <td><?php echo $cat->slug; ?></td>
                                    <td><?php echo $cat->sPic; ?></td>
                                    <td><?php echo $cat->status==1?'Active':'Inactive'; ?></td>
                                    <td>
                                        <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('category/remove', array('id'=>$cat->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a> 
                                        <a title="Edit" href="<?php echo Yii::app()->createUrl('category/update', array('id'=>$cat->id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                     </td>
                                </tr>
                                <?php } ?>                                            
                            </tbody>
