<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <?php /*?><li><a href="<?php echo Yii::app()->createUrl('faq/view'); ?>">FAQ(s)</a></li><?php */?>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="form-group">
                        <a href="<?php echo Yii::app()->createUrl('faq/create'); ?>" class="btn btn-success">Add New Qustion/Answer</a>
                        <a href="<?php echo Yii::app()->createUrl('faq/category'); ?>" class="btn btn-success">Category</a>
                    </div>
                    <?php
                        ...
                        <table id="example1" class="table table-bordered table-striped table-userbox">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $cat->answer; ?></td>
                                    <td><?php echo $cat->status==1?'Active':'Inactive'; ?></td>
                                    <td>
                                        <a title="Edit" href="<?php echo Yii::app()->createUrl('faq/update', array('id'=>$cat->id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                        <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('faq/remove', array('id'=>$cat->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a>
                                     </td>                                           
                                </tr>
                                <?php } ?>                                            
                            </tbody>
