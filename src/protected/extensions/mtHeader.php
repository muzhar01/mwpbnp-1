...
class mtHeader
{
            ...
            foreach ($arguments as $scope=>$param) {
                ...
                if (method_exists(__CLASS__, $method)) {
                    if (!is_array($param)) {
                        ...
                        forward_static_call_array(array(__CLASS__, $method), $param);
                    }
     ...
     *
     * @param string  $fileName The desired name of the file when it's downloaded
     * @param integer $fileSize The size in bytes. [Optinal]
     *
     * @return void
     */
