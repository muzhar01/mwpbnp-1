...
//	$config['img_path'] = '/rapidmember_data/images'; // Relative to domain name
//	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	if( Yii::app()->params['main_domain'] == 'devrapidmember.com'){
	   $config['upload_path'] = '/var/lampp/apache2/htdocs/RapidMember/images/'.$_SERVER['HTTP_HOST'].'/images';
	}else if( Yii::app()->params['main_domain'] == 'dev.rapidmemberpro.com'){
	   $config['upload_path'] = '/home/devrapid/public_html/images/'.$_SERVER['HTTP_HOST'].'/images';
	}else{
	   $config['upload_path'] = '/home/rapid/public_html/images/'.$_SERVER['HTTP_HOST'].'/images';
	}
