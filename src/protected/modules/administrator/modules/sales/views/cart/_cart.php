...
if(!Yii::app()->user->isGuest && Yii::app()->user->role==2){
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                   array('name'=>'product_id','value'=>'$data->product->name. "wprlomg<br />".stripslashes($data->size->title)." / ".stripslashes($data->thickness->title).$data->chowkat."[".$data->ckt_qty."]"','type'=>'raw'),
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'pagerCssClass' => 'box-footer clearfix',
                'columns' => array(
                    array('name'=>'product_id','value'=>'$data->product->name. "<br /> <small>".stripslashes($data->size->title)." / ".stripslashes($data->thickness->title).$data->chowkat." <small>"','type'=>'raw'),
                    array('name'=>'price','value'=>'$data->getPrice()." / ". $data->unit'),
                    array(
                    'name' => 'quantity',
                    'type' => 'raw',
