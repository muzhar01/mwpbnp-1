        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group"> 
                        <?php echo $form->labelEx ($modelQoute, 'comments'); ?>
                        <?php echo $form->textArea ($modelQoute, 'comments', array('class' => 'form-control', 'rows' => 10, 'cols' => 255)); ?>
                        <?php echo $form->error ($modelQoute, 'comments'); ?>
                </div>
                </div>
                </div>
            </div>
