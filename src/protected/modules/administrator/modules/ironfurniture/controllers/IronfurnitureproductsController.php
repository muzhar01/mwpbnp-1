...
class IronFurnitureProductsController extends Controller
{
	/**
	...
	public $resource_id=10;
        ...
        public function init() {
            $this->homeUrl=$this->baseUrl .= '/ironfurnitureproducts'; //Backend, I am using for Admin
	...
	public function actionCreate()
	{
            if (AdminUser::model()->findByPk(Yii::app()->user->id)->checkAccess($this->resource_id, 'add')) {
                $model=new IronFurnitureProducts;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['IronFurnitureProducts']))
		{
			$model->attributes=$_POST['IronFurnitureProducts'];
			if($model->save())
	 ...
	 * @return IronFurnitureProducts the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=IronFurnitureProducts::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param IronFurnitureProducts $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='iron-furniture-products-form')
		{
