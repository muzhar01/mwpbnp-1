    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            if (AdminUser::model()->findByPk(Yii::app()->user->id)->checkAccess($this->resource_id, 'add'))
                echo CHtml::link('<i class="fa fa-plus-square" aria-hidden="true"></i> Create Product Size', $this->baseUrl . '/create', array('class' => 'btn btn-success', 'style' => 'float:right'));
            ?>        </div>
        <div class="box-body">
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'published' => array(
                                ...
                                'url' => 'Yii::app()->createUrl("/administrator/products/productsize/published", array("id"=>$data->id))',
