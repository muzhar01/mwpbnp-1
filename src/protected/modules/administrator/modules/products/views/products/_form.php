        ...
        <?php if (!$model->isNewRecord) { ?>
            <div class="col-lg-6">
                <div class="form-group">
                    <?php
                    echo
                    (!empty($model->image)) ? CHtml::image(Yii::app()->request->baseUrl . '/images/products/' . $model->image, "image", array("width" => 200)) : CHtml::image(Yii::app()->request->baseUrl . '/images/products/no-image.png', "image", array("width" => 200));
                    ?>
                </div>
            </div>
        <?php } ?>
