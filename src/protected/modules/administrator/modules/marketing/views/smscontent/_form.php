...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model,'sms_urdu_content'); ?>
        <?php echo $form->textArea($model,'sms_urdu_content',array('class' => 'form-control','rows'=>3, 'cols'=>50)); ?>
                <p class="hint"></p>
        <?php echo $form->error($model,'sms_urdu_content'); ?>
    </div>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model,'email_urdu_content'); ?>
       <textarea name="SmsContent[email_urdu_content]" rows="" dir="ltr" style="width: 100%; height: 100px"><?php echo $model->email_urdu_content;?></textarea>
          
    </div>

     <div class="form-group">
        <label>Urdu Editor</label>
       <textarea id="editor" rows="" dir="ltr" style="width: 100%; height: 100px"></textarea>
