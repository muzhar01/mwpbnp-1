...
<?php $this->renderPartial('_client_small', array('model' => $model)); ?>
<div class="row">
...
<div class="row">
    <div class="col-lg-8 col-xs-8"><br />
        Received By: ________________________ <br /><br />
        CNIC / ID: _______________________________  <br /><br />
        Phone/Cell No.: ________________________ <br /><br /><br />
        
        Vehicle No: _______________________________  <br /><br />
        Date & Time: ________________________ <br /><br />
        Office Stamp: _______________________________  <br /><br />
    </div>
