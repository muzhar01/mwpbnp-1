    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
            ...
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'phone_office', array('placeholder' => 'e.g 0092511234567','size' => 60, 'maxlength' => 100, 'class' => 'form-control')); ?>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="row">
                ...
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'cellular'); ?>
                        ...
                        <?php echo $form->textField($model, 'cellular', array('placeholder' => 'e.g 00923001234567', 'size' => 20, 'maxlength' => 20, 'class' => 'form-control')); ?>
            ...
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'cellular2', array('placeholder' => 'e.g 00923001234567','size' => 60, 'maxlength' => 100, 'class' => 'form-control')); ?>
                <?php echo $form->error($model, 'cellular2'); ?>
            </div>
            <div class="form-group">
                <?php echo $form->labelEx($model, 'cellular3'); ?>
                <?php echo $form->textField($model, 'cellular3', array('placeholder' => 'e.g 00923001234567','size' => 60, 'maxlength' => 100, 'class' => 'form-control')); ?>
