...
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Market Price of <?php echo CHtml::encode($model->name);  ?></h3>
        </div>
        <div class="box-body">
                            <?php
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <?php  foreach ($thickness as $thicknessdata) {
                               $modelMarketPrice= ProductMarketPrice::model ()->find (array('condition'=>"product_id=$model->id AND size_id= $sizedata->size_id AND thickness_id = $thicknessdata->thickness_id",'order'=>"created_date DESC"));
                               $price = ($modelMarketPrice) ? $modelMarketPrice->price : 0.00;
                               ?>
        ...
        <?php echo CHtml::submitButton ( 'Save Product Market Price', array('class' => 'btn btn-success')); ?>
              </div>
