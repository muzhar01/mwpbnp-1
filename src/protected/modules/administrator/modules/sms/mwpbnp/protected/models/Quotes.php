...
class Quotes extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('billing_address, shipping_address', 'length', 'max' => 255),
            ...
            array('id, member_id, created_on, status, last_modified, billing_name, billing_address, billing_city, billing_zipcode, billing_cellno, billing_phoneno, shipping_name, shipping_address, shipping_city, shipping_zipcode, shipping_cellno, shipping_phoneno, payment_type, quote_value, carriage, quote_type, chowak_installation', 'safe', 'on' => 'search'),
        );
    }
