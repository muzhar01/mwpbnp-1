...
class RmplistController extends Controller
{
	/**
	...
	public $resource_id=25;
        ...
        public function init() {
            $this->homeUrl=$this->baseUrl .= '/rmplist'; //Backend, I am using for Admin
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['RmpList']))
		{
			$model->attributes=$_POST['RmpList'];
			if($model->save())
	...
	{
            if (AdminUser::model()->findByPk(Yii::app()->user->id)->checkAccess($this->resource_id, 'view')) {
                $model=new RmpList('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RmpList']))
			$model->attributes=$_GET['RmpList'];
	 ...
	 * @return RmpList the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=RmpList::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RmpList $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rmp-list-form')
		{
