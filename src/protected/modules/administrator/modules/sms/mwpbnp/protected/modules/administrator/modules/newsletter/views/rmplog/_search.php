...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="col-lg-3 col-md-2 col-sm-12">
              <?php echo $form->textField($model,'subscriber_id',array('class' => 'form-control','size'=>50,'maxlength'=>50,'placeholder'=>'Subscriber Name')); ?>
	</div>
	<div class="col-lg-3 col-md-2 col-sm-12">
              <?php 
	...
	<div class="col-lg-2 col-md-2 col-sm-12">
		<?php echo $form->textField($model,'status',array('class' => 'form-control','size'=>50,'maxlength'=>50,'placeholder'=>'status')); ?>
	</div>
