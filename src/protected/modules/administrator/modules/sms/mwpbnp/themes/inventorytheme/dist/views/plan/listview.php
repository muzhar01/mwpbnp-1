...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            <a href="<?php echo Yii::app()->createUrl('plan/view'); ?>">Plan(s)</a>
            <small>List</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo Yii::app()->createUrl('admin/dashboard'); ?>">Dashboard</a></li>
            <li><a href="<?php echo Yii::app()->createUrl('plan/view'); ?>">Plan(s)</a></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Plan(s)</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body table-responsive">
                    <div class="form-group">
                    <a href="<?php echo Yii::app()->createUrl('plan/create'); ?>" class="btn btn-success">Create New</a>
                    </div>
                    <?php
                        ...
                        <table id="example1" class="table table-bordered table-striped table-userbox">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Helpers::_frequency($cat->frequency); ?></td>
                                    <td><?php echo $cat->content; ?></td>
                                    <td><?php echo $cat->status==1?'Active':'Inactive'; ?></td>
                                    <td>
                                        <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('plan/remove', array('id'=>$cat->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a> 
                                        <a title="Edit" href="<?php echo Yii::app()->createUrl('plan/update', array('id'=>$cat->id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                     </td>
                                </tr>
                                <?php } ?>                                            
                            </tbody>
