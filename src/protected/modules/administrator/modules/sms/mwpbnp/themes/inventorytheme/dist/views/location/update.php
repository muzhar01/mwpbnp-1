						...
						<div class="col-md-4">
							...
							<div class="box box-primary">
								<div class="box-header">
									<h3 class="box-title">Edit <?php echo $type; ?></h3>
								</div><!-- /.box-header -->
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="loc_button" class="btn btn-primary">Update</button>
                                    </div>
                                </div><!-- /.box-body -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Edit" href="<?php echo Yii::app()->createUrl('location/view', array('type'=>$loc->type, 'id'=>$loc->id)); ?>"><i class="fa fa-edit"></i> Edit</a></td>
                                            </tr>
                                            <?php } ?>                                            
                                        </tbody>
                                    </table>
