        ...
        <div class="col-md-9">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Plan Add/Edit</h3>
                </div><!-- /.box-header -->
                ...
                <div class="box-body">
					...
					<div class="form-group">
                        ...
                        <?php echo CHtml::dropDownList('Plan[frequency]', $model->frequency, Helpers::_frequency(), array('class' => "form-control")); ?>
                    </div>                    
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <select class="form-control error" name="Plan[status]" id="Plan_status">
