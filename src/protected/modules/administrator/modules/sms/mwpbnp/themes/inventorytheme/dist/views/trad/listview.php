            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Trad(s)</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body table-responsive">
                    <div class="form-group">
                    <a href="<?php echo Yii::app()->createUrl('trad/create'); ?>" class="btn btn-success">Create New</a>
                    </div>
                    <?php
                        ...
                        <table id="example1" class="table table-bordered table-striped table-userbox">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('trad/remove', array('id'=>$cat->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a> 
                                        <a title="Edit" href="<?php echo Yii::app()->createUrl('trad/update', array('id'=>$cat->id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                     </td>
                                </tr>
                                <?php } ?>                                            
                            </tbody>
