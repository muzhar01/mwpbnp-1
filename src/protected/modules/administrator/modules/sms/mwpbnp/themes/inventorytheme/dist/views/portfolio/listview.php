            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Portfolio(s)</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body table-responsive">
                    <div class="form-group">
                    <a href="<?php echo Yii::app()->createUrl('portfolio/create'); ?>" class="btn btn-success">Create New</a>
                    </div>
                        <?php
                        ...
                        <table id="example1" class="table table-bordered table-striped table-userbox">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" name="post_ids[]" class="checkbox" value="<?php echo $post->id; ?>" /></td>
                                    <td><?php echo $post->title; ?></td>
                                    <td><?php echo $post->block; ?></td>
                                    <td><?php echo $post->shomePic; ?></td>
                                    <td><?php echo $post->sPic; ?></td>
                                    <td>
                                        <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('portfolio/remove', array('id'=>$post->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a> 
                                        <a title="Edit" href="<?php echo Yii::app()->createUrl('portfolio/update', array('id'=>$post->id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                    </td>
                                </tr>
                                <?php } ?>                                            
                            </tbody>
