...
/**
 * This is the model class for table "product_weight_listings_chowkat_tool".
 *
 * The followings are the available columns in table 'product_weight_listings_chowkat_tool':
 * @property integer $id
 ...
 */
class ProductWeightListingsChowkatTool extends CActiveRecord
{
	/**
	...
	{
		return 'product_weight_listings_chowkat_tool';
	}
	 ...
	 * @return ProductWeightListingsChowkatTool the static model class
	 */
