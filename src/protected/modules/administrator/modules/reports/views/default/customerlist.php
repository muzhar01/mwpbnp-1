...
<section class="content">
    <div class="box box-info" id="otherArea">
                ...
                <form method="post" action="">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="margin-top: 24px">
                            <a class="btn btn-success pull-right" href="exportcustomerlist?zone=<?php echo isset($zone)?$zone:'';?>&area=<?php echo isset($area)?$area:'';?>&salesOfficer=<?php echo isset($sales_officer)?$sales_officer:'';?>"><i class="fa fa-download"></i> Export List</a> &nbsp;
                            <a class="btn btn-danger pull-right" style="margin-right: 2px;" onclick="printData()"   id="print"><i class="fa fa-print"></i> Print List</a>&nbsp;
                            <input type="submit" name="search" style="margin-right: 2px;" class="btn btn-primary pull-right" value="Search">&nbsp;
                        </div>
                    </div>
                </form>
        </div>
