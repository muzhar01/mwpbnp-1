...
class RmpsubscribersController extends Controller
{
	/**
	...
	public $resource_id=25;
        ...
        public function init() {
            $this->homeUrl=$this->baseUrl .= '/rmpsubscribers'; //Backend, I am using for Admin
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['RmpSubscribers']))
		{
			$model->attributes=$_POST['RmpSubscribers'];
			if($model->save())
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['RmpSubscribers']))
		{
			$model->attributes=$_POST['RmpSubscribers'];
               ...
               $model->list_id=explode(',',$model->ListString);
	 ...
	 * @return RmpSubscribers the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=RmpSubscribers::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RmpSubscribers $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rmp-subscribers-form')
		{
