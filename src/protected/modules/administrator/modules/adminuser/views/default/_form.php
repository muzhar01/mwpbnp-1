...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'activiation_code'); ?>
		<?php echo $form->textField($model,'activiation_code',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'activiation_code'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'lastlogin_on'); ?>
		<?php echo $form->textField($model,'lastlogin_on'); ?>
		<?php echo $form->error($model,'lastlogin_on'); ?>
	</div>
