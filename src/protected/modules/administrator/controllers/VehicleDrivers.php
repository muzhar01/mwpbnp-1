...
class VehicleDrivers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cnic, FullName, FatherName, current_salary, last_increament_date, salary_leave_terms, performance_remarks, appointment_terms, appointment_date, contact_number, address, added_on, created_by', 'required'),
			array('salary_last_increament, added_on, updated_by', 'numerical', 'integerOnly'=>true),
