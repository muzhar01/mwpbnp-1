...
//                             ),
                            'update' => array(
                                ...
                                'url' => 'Yii::app()->createUrl("/administrator/vehicles/UpdateVehicle", array("id"=>$data->id))',
                            ),
                            'view' => array(
                            ...
                            'delete' => array(
                                ...
                                'url' => 'Yii::app()->createUrl("/administrator/vehicles/DeleteVehicle/", array("id"=>$data->id))',
                            ),
                        ),
                    ),
                ),
