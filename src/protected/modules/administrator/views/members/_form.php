				...
				<div class="row">
					<div class="col-lg-9 col-md-9">
						...
						<div class="input-group">
							...
							<div class="input-group-addon" title="cnic is verified"><i class="fa <? echo ( $model->is_enable == 0) ? 'fa fa-square-o':'fa-check-square'?>"></i> </div>
						</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-lg-9 col-md-9">
						...
						<div class="input-group">
							<?php 
							if($model->verify_company_ntn_no == 1){
								echo $form->textField($model, 'company_ntn_no', array('size' => 60, 'maxlength' => 100, 'class' => 'form-control','readonly'=>'readonly'));
							}else{
								echo $form->textField($model, 'company_ntn_no', array('size' => 60, 'maxlength' => 100, 'class' => 'form-control'));
							} ?>
							<div class="input-group-addon" title="cnic is verified"><i class="fa <? echo ( $model->is_enable == 0) ? 'fa fa-square-o':'fa-check-square'?>"></i> </div>
						</div>
					...
					<div class="col-lg-3 col-md-3">
						<div class="form-group" style="margin-top: 30px;">
							<?php echo $form->labelEx($model, 'verify_company_ntn_no'); ?>
							<?php  echo $form->checkBox($model, 'verify_company_ntn_no'); ?>
							<?php echo $form->error($model, 'verify_company_ntn_no'); ?>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-lg-9 col-md-9">
						...
						<div class="input-group">
							<?php 
							if($model->verify_company_gst_no == 1){
								echo $form->textField($model, 'company_gst_no', array('size' => 60, 'maxlength' => 100, 'class' => 'form-control','readonly'=>'readonly'));
							}else{
								echo $form->textField($model, 'company_gst_no', array('size' => 60, 'maxlength' => 100, 'class' => 'form-control'));
							} ?>
							<div class="input-group-addon" title="cnic is verified"><i class="fa <? echo ( $model->is_enable == 0) ? 'fa fa-square-o':'fa-check-square'?>"></i> </div>
						</div>
					...
					<div class="col-lg-3 col-md-3">
						<div class="form-group" style="margin-top: 30px;">
							<?php echo $form->labelEx($model, 'verify_company_gst_no'); ?>
							<?php  echo $form->checkBox($model, 'verify_company_gst_no'); ?>
							<?php echo $form->error($model, 'verify_company_gst_no'); ?>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php echo $form->textField($model, 'office_geo_lat', array('class' => 'form-control hidden', 'id' => 'lat')); ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo $form->textField($model, 'office_geo_lng', array('class' => 'form-control hidden', 'id' => 'lng')); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	$('#Members_verify_cnic').on('click', function () {
        if ($(this).prop('checked')) {
            $('#Members_cnic').prop('readOnly', true);
        } else {
            $('#Members_cnic').prop('readOnly', false);
        }
    });
	
	$('#Members_verify_company_ntn_no').on('click', function () {
        if ($(this).prop('checked')) {
            $('#Members_company_ntn_no').prop('readOnly', true);
        } else {
            $('#Members_company_ntn_no').prop('readOnly', false);
        }
    });
	
	$('#Members_verify_company_gst_no').on('click', function () {
        if ($(this).prop('checked')) {
            $('#Members_company_gst_no').prop('readOnly', true);
        } else {
            $('#Members_company_gst_no').prop('readOnly', false);
        }
    });
