        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <a href="<?php echo Yii::app()->createUrl('package/create'); ?>" class="btn btn-success">Create New</a>
                    </div>
                        <?php
                        ...
                        <table id="example1" class="table table-bordered table-striped table-userbox">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $post->Pic; ?></td>
                                    <td>
                                        <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('package/remove', array('id'=>$post->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a> 
                                        <a title="Edit" href="<?php echo Yii::app()->createUrl('package/update', array('id'=>$post->id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                    </td>
                                </tr>
                                <?php } ?>                                            
                            </tbody>
