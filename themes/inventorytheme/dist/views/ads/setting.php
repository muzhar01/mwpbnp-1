...
<!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Ad Setting(s)
                        <small>Add New & List</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Ad Setting(s)</a></li>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <?php echo $this->renderPartial('_formSize', array('model'=>$create)); ?>
                        ...
                        <div class="col-xs-8">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ad Setting(s)</h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('ads/removeSetting', array('id'=>$ad->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a>
                                                    <a title="Edit" href="<?php echo Yii::app()->createUrl('ads/setting', array('id'=>$ad->id)); ?>"><i class="fa fa-edit"></i> Edit</a></td>
                                            </tr>
                                            <?php } ?>                                            
                                        </tbody>
                                        <tfoot>
