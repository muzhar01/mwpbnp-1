...
<h5>Archive's Rate</h5>
<table class="table table-condensed table-bordered">
                        <tr >
                            <th class="bg-gray"></th>
                            <th class="bg-gray" colspan="<?php echo $total_thickness ?>">Thickness (Mini. Price- Max. Price)</th>
                        </tr>
                        <tr>
                        ...
                        <?php foreach ($size as $sizedata) { ?>
                               <tr>
                                   ...
                                   foreach ($thickness as $thicknessdata) {
                                          $row = ProductArchivePrice::model ()->ArchivePrice($data->id,$sizedata->size_id,$thicknessdata->thickness_id,$date);
                                          ?>
                                          <td ><?php echo $row['min_price'] ?> - <?php echo $row['max_price'] ?></td>
                                   <?php } ?>
                               </tr>
                        <?php } ?>
