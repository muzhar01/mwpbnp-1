...
class SmsContent extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('status_id,sms_content,sms_urdu_content,email_content,email_urdu_content', 'required'),
            ...
            array('id, status_id, sms_content,sms_urdu_content,email_urdu_content, email_content, published, created_date, created_by', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'sms_urdu_content' => 'Sms Content In Urdu',
            'email_urdu_content' => 'Email Content In Urdu',
    ...
    public function search() {
        ...
        $criteria->compare('sms_urdu_content', $this->sms_urdu_content, true);
        $criteria->compare('email_urdu_content', $this->email_urdu_content, true);
