                        ...
                        <div class="info-box bg-blue">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description">
                                        <a href="/administrator/smsemail/default/members" style="color: #fff;"><i class="fa fa fa-user"></i> See all members</a>
                                    </span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-red">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description">
                                        <a href="/administrator/smsemail/smstriggerstatus" style="color: #fff;"><i class="fa fa-list"></i> See all status</a>
                                    </span>
                            </div><!-- /.info-box-content -->
                        </div><!-- /.info-box -->
                    </div><!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-green">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description">
                                        <a href="/administrator/smsemail/smscontent" style="color: #fff;"><i class="fa fa-newspaper-o"></i> See all content</a>
                                    </span>
                            </div><!-- /.info-box-content -->
                        </div><!-- /.info-box -->
                    </div><!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-yellow">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description">
                                        <a href="/administrator/sales/cart" style="color: #fff;"><i class="fa fa-clock-o"></i> See all</a>
                                    </span>
                            </div><!-- /.info-box-content -->
                        </div><!-- /.info-box -->
                    </div><!-- /.col -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-aqua-gradient">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description">
                                        <a href="/administrator/sales/cart" style="color: #fff;"><i class="fa fa-arrow-circle-down"></i> See all</a>
                                    </span>
                            </div><!-- /.info-box-content -->
                        </div><!-- /.info-box -->
                    </div><!-- /.col -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-maroon-gradient">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description">
                                        <a href="/administrator/sales/cart" style="color: #fff;"><i class="fa fa-arrow-circle-up"></i> See all</a>
                                    </span>
                            </div><!-- /.info-box-content -->
                        </div><!-- /.info-box -->
                    </div><!-- /.col -->
