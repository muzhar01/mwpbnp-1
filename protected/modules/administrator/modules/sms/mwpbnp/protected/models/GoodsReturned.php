 ...
 *
 */
class GoodsReturned extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'customer_goods_return';
    }
    ...
    public function search() {
        ...
        $criteria->compare('return_reason', $this->return_reason);
        $criteria->compare('goods_description', $this->goods_description);
