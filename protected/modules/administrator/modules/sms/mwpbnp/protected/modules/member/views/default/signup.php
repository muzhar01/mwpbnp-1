    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="form">
            ...
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'cellular', array('class' => 'form-control', 'size' => 40, 'maxlength' => 50, 'placeholder' => 'e.g 00923001234567')); ?>
                <?php echo $form->error($model, 'cellular', array('class' => 'alert alert-danger')); ?>
            </div>
            <div class="form-group">
                <?php echo $form->labelEx($model, 'phone_office'); ?>
                <?php echo $form->textField($model, 'phone_office', array('class' => 'form-control', 'size' => 40, 'maxlength' => 50, 'placeholder' => 'e.g 00923001234567')); ?>
