...
<html>
    ...
    <body class="sidebar-mini skin-red">
        ...
        <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/app.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/demo.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/countdown.js" type="text/javascript"></script>
