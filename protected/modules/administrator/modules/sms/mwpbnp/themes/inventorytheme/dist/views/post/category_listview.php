            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Market(s)</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body table-responsive">
                    <div class="form-group">
                    <a href="<?php echo Yii::app()->createUrl('post/marketCreate', $pid); ?>" class="btn btn-success">Create New</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped table-userbox">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a title="Delete" onclick="return confirm('Are you sure?');" href="<?php echo Yii::app()->createUrl('post/marketRemove', array('id'=>$p->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a>
                                        <a title="Edit" href="<?php echo Yii::app()->createUrl('post/marketUpdate', array('id'=>$p->id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                    </td>
                                </tr>
                                <?php } ?>                                            
                            </tbody>
