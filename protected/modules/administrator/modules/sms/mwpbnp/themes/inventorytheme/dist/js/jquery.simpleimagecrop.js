	...
	$.fn.extend({ 
		...
		simpleImageCrop: function(options) {
			...
			var defaults = {
				...
				redirectLocation: 'http://woolance.com',
		...
		return this.each(function() {
			...
			$('#crop_button').click(function() {
				...
				$.ajax({
					...
					data: {x: x, y: y, w: w, h: h, dimension_x: o.newImageWidth, dimension_y: o.newImageHeight, image_path: imagePath, image_destination: o.imageDestination, destinationPath: destinationPath}, 
					type: 'post',
					success: function(html) {
						alert(o.successMessage);
