...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group col-md-4">
		...
		<?php echo $form->textField($model,'FullName',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'FullName'); ?>
	</div>

	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'FatherName'); ?>
		<?php echo $form->textField($model,'FatherName',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'FatherName'); ?>
	</div>

	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'cnic'); ?>
		<?php echo $form->textField($model,'cnic',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'cnic'); ?>
	</div>
	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'contact_number'); ?>
		<?php echo $form->textField($model,'contact_number',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'contact_number'); ?>
	</div>

	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'current_salary'); ?>
		<?php echo $form->textField($model,'current_salary',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'current_salary'); ?>
	</div>

	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'salary_last_increament'); ?>
		<?php echo $form->textField($model,'salary_last_increament',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
	...
	<div class="form-group col-md-4">
		...
		<?php echo $form->textField($model,'salary_leave_terms',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'salary_leave_terms'); ?>
	</div>

	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'performance_remarks'); ?>
		<?php echo $form->textField($model,'performance_remarks',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'performance_remarks'); ?>
	</div>
	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'appointment_date'); ?>
		<?php echo $form->dateField($model,'appointment_date',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'appointment_date'); ?>
	</div>
	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'appointment_terms'); ?>
		<?php echo $form->textField($model,'appointment_terms',array('class' => 'form-control','size'=>60,'maxlength'=>200)); ?>
